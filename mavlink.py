...
Generated from: ('custom_attitude.xml',)
...
MAVLINK_MSG_ID_CUSTOM_ATTITUDE = 42000


class MAVLink_custom_attitude_message(MAVLink_message):
    """
    Custom attitude message for UDP test
    """

    id = MAVLINK_MSG_ID_CUSTOM_ATTITUDE
    msgname = "CUSTOM_ATTITUDE"
    ...
    def __init__(self, time_boot_ms: int, roll: float, pitch: float, yaw: float):
        MAVLink_message.__init__(self, MAVLink_custom_attitude_message.id, MAVLink_custom_attitude_message.msgname)
        self._fieldnames = MAVLink_custom_attitude_message.fieldnames
        self._instance_field = MAVLink_custom_attitude_message.instance_field
        self._instance_offset = MAVLink_custom_attitude_message.instance_offset
    ...
    def pack(self, mav: "MAVLink", force_mavlink1: bool = False) -> bytes:
        return self._pack(mav, self.crc_extra, self.unpacker.pack(self.time_boot_ms, self.roll, self.pitch, self.yaw), force_mavlink1=force_mavlink1)


# Define name on the class for backwards compatibility (it is now msgname).
# Done with setattr to hide the class variable from mypy.
setattr(MAVLink_custom_attitude_message, "name", mavlink_msg_deprecated_name_property())


mavlink_map: Dict[int, Type[MAVLink_message]] = {
    MAVLINK_MSG_ID_CUSTOM_ATTITUDE: MAVLink_custom_attitude_message,
}
...
class MAVLink(object):
    ...
    def custom_attitude_encode(self, time_boot_ms: int, roll: float, pitch: float, yaw: float) -> MAVLink_custom_attitude_message:
        """
        Custom attitude message for UDP test
        ...
        """
        return MAVLink_custom_attitude_message(time_boot_ms, roll, pitch, yaw)

    def custom_attitude_send(self, time_boot_ms: int, roll: float, pitch: float, yaw: float, force_mavlink1: bool = False) -> None:
        """
        Custom attitude message for UDP test
        ...
        """
        self.send(self.custom_attitude_encode(time_boot_ms, roll, pitch, yaw), force_mavlink1=force_mavlink1)
